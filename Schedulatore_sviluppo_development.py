...
tab1, tab4, tab2, tab3 = st.tabs(['Input dati', 'Scaduto','Programma FERRARA','Altri siti'])
...
with tab1:
    ...
    with col_a:
        ...
        st.write('Versione aggionata del 06/03/2024 - Modifiche introdotte:')
        st.write('- Visualizzazione dello scaduto da inizio anno suddiviso per Standby / non Standby')
