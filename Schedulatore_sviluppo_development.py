...
# Introdurre nota orario consentito
# Filtro data per visualizzazione dati
...
with tab1:
    ...
    with col_a:
        ...
        st.write('Versione aggionata del 20/02/2024 - Modifiche introdotte:')
        st.write('- Range su interventi mensili +/- 5 giorni')
        st.write('- Aggiunto numero OP / Op vincolo ad altri siti')
    with col_b:
