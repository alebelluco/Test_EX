...
tab1, tab2, tab3 = st.tabs(['Input dati','Programma FERRARA','Altri siti'])

with tab1:
    #path_clara = '/Users/Alessandro/Documents/AB/Clienti/AB/Exera/Programmazione/Dicemebre/Clara_allowed.xlsx'
    #path_clara = '/Users/Alessandro/Documents/AB/Clienti/AB/Exera/Programmazione/Flatfiles/Clara_allowed.csv'
    path_clara = 'https://github.com/alebelluco/Test_EX/blob/main/Clara_allowed.csv'

    #ordine_siti = pd.read_excel('/Users/Alessandro/Documents/AB/Clienti/AB/Exera/Programmazione/Siti_territoriali.xlsx')
    ordine_siti = pd.read_csv('https://github.com/alebelluco/Test_EX/blob/main/Siti_territoriali.csv', delimiter=';')
    #ordine_siti = pd.read_csv('/Users/Alessandro/Documents/AB/Clienti/AB/Exera/Programmazione/Flatfiles/Siti_territoriali.csv', delimiter=';')
    ...
    siti = pd.read_csv('https://github.com/alebelluco/Test_EX/blob/main/cantieri.csv',delimiter=';')
    ...
    with col_b:
        ...
        st.image('https://github.com/alebelluco/Test_EX/blob/main/exera_logo.png')
    ...
    st.dataframe(mese[0:5].drop(columns=['key','key_sito','key_univoca'], axis=1))
   ...
   # st.write('Dati importati')
    ...
    st.write('Interventi in standby')
    st.write(standby)
...
with tab2:
    ...
    st.dataframe(visualizzazione[visualizzazione.operatore == scelta_op])

with tab3:
    altri_siti  = altri_siti.merge(vincolo_nop, how='left',left_on='ID',right_on='ID')
    st.dataframe(altri_siti[altri_siti.columns[1:12]].drop('Note', axis=1), width=2500)
